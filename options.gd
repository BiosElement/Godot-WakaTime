...
func refresh():
	...
	if settings.has_setting("WakaTime/Hide_Project_Name"):
		hide_project_name.pressed = settings.get_setting("WakaTime/Hide_Project_Name")
	if settings.has_setting("WakaTime/Hide_Filenames"):
		hide_filenames.pressed = settings.get_setting("WakaTime/Hide_Filenames")
	if settings.has_setting("WakaTime/Hide_Project_Folder"):
		hide_filenames.pressed = settings.get_setting("WakaTime/Hide_Project_Folder")
